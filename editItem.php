...
<html lang="en">
	...
	<body class="bg-light">
        ...
        $cursor = $collection->findOne(['_id' => $itemid]);
        // print_r($cursor);
        ...
        echo '<br/><br/>';
        echo '<form action="FinalEditItem.php" method="POST" style="padding-right:30%; padding-left:30%;">
        <div class="form-group">								
            <input type="text" class="form-control" name="itemid" id="itemid" value="'.$cursor['_id'] .'" readonly> 
        </div>
        <div class="form-group">								
            <input type="text" class="form-control" name="itemName" id="itemName" value="'.$cursor['name'] .'"> 
        </div>
        <div class="form-group">
            <input type="text" class="form-control" name="itemImage" id="itemImage" value="'.$cursor['img-url'] .'">
        </div>
        <div class="form-group">								
            <input type="text" class="form-control" name="itemDescription" id="itemDescription" value="'.$cursor['description'] .'">    </div>
        <div class="form-group">
            <input type="text" class="form-control" name="itemPrice" id="itemPrice" value="'.$cursor['price'] .'">  
        </div>
