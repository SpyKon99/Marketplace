	...
	<body class="bg-light">
        ...
        <div class="modal-body cart-items" id="cart" style="margin-left:100px">
			<div class="row row-title" style="font-size:25px;">
				...
				<div class="col"><p id="test1"><u>Χρήστης</u></p></div>
				<div class="col"><p id="test1"><u>Προϊον</u></p></div>			
			</div>
		<?php
            ...
            <div class="col"><p id="test1">'.$document['user'].'</p></div>
            <div class="col"><p id="test1">'.$document['item'].'</p></div>					 				
					</div>';										                    
            }
